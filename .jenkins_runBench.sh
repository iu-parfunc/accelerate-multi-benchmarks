...
## RUN UNFISSED BENCHMARKS ON CUDA AND MULTI  
 for variant in cuda; do # not multi
   ...
   case $executable in 
     accelerate-nbody)  	   
       for arg in 50000 60000 70000 80000 90000 100000 110000 120000 130000 140000 150000 160000 170000 180000 190000 200000; do
     ...
     accelerate-mandelbrot) 
       ...
       ;;
     accelerate-mmult) 
       for arg in 100 200 300 400 500 600 700 800 900 1000; do	       
     ...
     memboundmegapar) 
       ...
       ;;
     accelerate-crystal) 
       for arg in 10000 20000 30000 40000 50000; do
